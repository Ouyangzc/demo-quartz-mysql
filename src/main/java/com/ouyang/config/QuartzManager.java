...
public class QuartzManager {
   ...
   */
  public void addOrUpdateJob(Class<? extends QuartzJobBean> jobClass, String jobName,
    ...
    try {
      ...
      if (jobTimes < 0) {
        trigger = TriggerBuilder.newTrigger().withIdentity(jobName, jobGroupName)
            .withSchedule(
                SimpleScheduleBuilder.repeatSecondlyForever(1).withIntervalInSeconds(jobTime))
            .startNow().build();
      } else {
  ...
  public List<JobDetails> queryAllJobBean() {
