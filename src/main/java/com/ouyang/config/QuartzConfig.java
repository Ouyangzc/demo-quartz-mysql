...
public class QuartzConfig {
  ...
  public SchedulerFactoryBean scheduler(DataSource dataSource) throws IOException {
    ...
    quartzProperties.setProperty(QuartzConstant.QUARTZ_PROPERTY_SCHEDULER_INSTANCE_NAME_KEY, QuartzConstant.QUARTZ_PROPERTY_SCHEDULER_INSTANCE_NAME_VALUE+"-1");
